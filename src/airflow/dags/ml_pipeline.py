...
def ml_pipeline():
    @task.virtualenv(
        ...
        requirements=[
            "--trusted-host 172.19.0.2",
            "--extra-index-url http://172.19.0.2:8080",
    ...
    def run_feature_pipeline(
        ...
        from feature_pipeline import pipeline, utils
    ...
    def train_from_best_config(feature_view_metadata: dict) -> dict:
        ...
        from training_pipeline import train, utils
